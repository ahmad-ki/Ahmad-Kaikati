function serviceMap(input, deployment) {
  ...
  return {
    provider: 'Azure (AKS/Container Apps/VMs)',
    compute:
      deployment.model === 'Serverless'
        ...
        : 'Azure VMs',
    database: nosql ? 'Cosmos DB' : 'Azure Database for PostgreSQL',
    cache: 'Azure Cache for Redis',
    queue: kafka ? 'Event Hubs (Kafka API)' : 'Service Bus',
    cdn: 'Azure Front Door + CDN',
    lb: 'Application Gateway + Load Balancer',
